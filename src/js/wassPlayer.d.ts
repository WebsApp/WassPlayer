...
declare class WassPlayer {
  /**
   * Setup a new instance
   */
  static setup(targets: NodeList | HTMLElement | HTMLElement[] | string, options?: WassPlayer.Options): WassPlayer[];
   ...
   */
  static supported(mediaType?: WassPlayer.MediaType, provider?: WassPlayer.Provider, playsInline?: boolean): WassPlayer.Support;

  constructor(targets: NodeList | HTMLElement | HTMLElement[] | string, options?: WassPlayer.Options);
  ...
  readonly fullscreen: WassPlayer.FullscreenControl;
   ...
   */
  on(
    event: WassPlayer.StandardEvent | WassPlayer.Html5Event,
    callback: (this: this, event: WassPlayer.WassPlayerEvent) => void,
  ): void;
...
declare namespace WassPlayer {
  ...
  interface Options {
    /**
     * Completely disable WassPlayer. This would allow you to do a User Agent check or similar to programmatically enable or disable WassPlayer for a certain UA. Example below.
     */
    enabled?: boolean;
    ...
    /**
     * Specify the id prefix for the icons used in the default controls (e.g. wassPlayer-play would be WassPlayer).
     ...
     */
    listeners?: { [key: string]: (error: WassPlayerEvent) => void };
  ...
  interface WassPlayerEvent extends CustomEvent {
    readonly detail: { readonly wassPlayer: WassPlayer };
  }
